...
public class BookControllerTest {
	...
	public void borrowAvailableBooksTest() throws Exception {
		...
		mockMvc.perform(post("/books")
				...
				.andExpect(jsonPath("$.borrowed[0].author.authorId", is(1)))
				.andExpect(jsonPath("$.borrowed[0].author.firstName", is("Suzanne")))
				.andExpect(jsonPath("$.borrowed[0].author.lastName", is("Collins")))
				.andExpect(jsonPath("$.borrowed[1].bookId", is(6)))
				.andExpect(jsonPath("$.borrowed[1].bookName", is("Catching Fire")))
				.andExpect(jsonPath("$.borrowed[1].author.authorId", is(1)))
				.andExpect(jsonPath("$.borrowed[1].author.firstName", is("Suzanne")))
				.andExpect(jsonPath("$.borrowed[1].author.lastName", is("Collins")));
	...
	public void borrowNotAvailableBooksTest() throws Exception {
		...
		mockMvc.perform(post("/books")
				...
				.andExpect(jsonPath("$.notAvailable[0].author.authorId", is(1)))
				.andExpect(jsonPath("$.notAvailable[0].author.firstName", is("Suzanne")))
				.andExpect(jsonPath("$.notAvailable[0].author.lastName", is("Collins")))
				...
				.andExpect(jsonPath("$.notAvailable[1].author.authorId", is(1)))
				.andExpect(jsonPath("$.notAvailable[1].author.firstName", is("Suzanne")))
				.andExpect(jsonPath("$.notAvailable[1].author.lastName", is("Collins")));
